...
public class AmazonInc {
    public static void main(String[] args) {
       ...
       ProductOwner po = new ProductOwner("Shuaib", 26, 'M', 123, 120000, company );

       BusinessAnalyst ba =  new BusinessAnalyst("Cihad", 30, 'M',126,125000,company);

       ScrumMaster sm = new ScrumMaster("Anel", 35,'F',121,121000,company);
        ...
        System.out.println("-----------------------------------------------------------------");
        // iterate the name of all testers
        ...
        System.out.println("----------------------------------------------------------------------");
        // iterate the name of all developers
