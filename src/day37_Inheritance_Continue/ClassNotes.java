...
super keyword: refers to the instances. parent class
    ...
    class Person{ // person: a                               // person is = buyuk baba
        a
    }

    class Employee extends Person{ // employee: a, b       //employee is = ogul
        b
    }

    class Tester extends Employee{ //tester: a, b, c     // tester is = torun
        c
    }
...
//  buyuk babadaki 1 ozelligi ogul ondan alirsa ogulun 2 ozelligi olur torun ise her
//  2 sinin ozelligini alirsa 3 ozelligi olur en zengin torun olur buyuk babadan ogula oguldan toruna miras kalmasi gibi
